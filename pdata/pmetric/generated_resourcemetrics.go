...
// MarshalProto marshals ResourceMetrics into proto bytes.
func (ms ResourceMetrics) MarshalProto() ([]byte, error) {
	orig := ms.orig
	size := orig.SizeProto()
	buf := make([]byte, size)
...
// UnmarshalProto unmarshalls ResourceMetrics from proto bytes.
func (ms ResourceMetrics) UnmarshalProto(data []byte) error {
	orig := ms.orig
...
// MarshalJSON marshals ResourceMetrics into JSON bytes.
func (ms ResourceMetrics) MarshalJSON() ([]byte, error) {
	orig := ms.orig
...
// UnmarshalJSON unmarshalls ResourceMetrics from JSON bytes.
func (ms ResourceMetrics) UnmarshalJSON(data []byte) error {
	orig := ms.orig
