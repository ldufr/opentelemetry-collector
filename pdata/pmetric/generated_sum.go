...
// MarshalProto marshals Sum into proto bytes.
func (ms Sum) MarshalProto() ([]byte, error) {
	orig := ms.orig
	size := orig.SizeProto()
	buf := make([]byte, size)
...
// UnmarshalProto unmarshalls Sum from proto bytes.
func (ms Sum) UnmarshalProto(data []byte) error {
	orig := ms.orig
...
// MarshalJSON marshals Sum into JSON bytes.
func (ms Sum) MarshalJSON() ([]byte, error) {
	orig := ms.orig
...
// UnmarshalJSON unmarshalls Sum from JSON bytes.
func (ms Sum) UnmarshalJSON(data []byte) error {
	orig := ms.orig
