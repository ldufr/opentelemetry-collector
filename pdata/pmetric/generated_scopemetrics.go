...
// MarshalProto marshals ScopeMetrics into proto bytes.
func (ms ScopeMetrics) MarshalProto() ([]byte, error) {
	orig := ms.orig
	size := orig.SizeProto()
	buf := make([]byte, size)
...
// UnmarshalProto unmarshalls ScopeMetrics from proto bytes.
func (ms ScopeMetrics) UnmarshalProto(data []byte) error {
	orig := ms.orig
...
// MarshalJSON marshals ScopeMetrics into JSON bytes.
func (ms ScopeMetrics) MarshalJSON() ([]byte, error) {
	orig := ms.orig
...
// UnmarshalJSON unmarshalls ScopeMetrics from JSON bytes.
func (ms ScopeMetrics) UnmarshalJSON(data []byte) error {
	orig := ms.orig
