...
// MarshalProto marshals Metric into proto bytes.
func (ms Metric) MarshalProto() ([]byte, error) {
	orig := ms.orig
	size := orig.SizeProto()
	buf := make([]byte, size)
...
// UnmarshalProto unmarshalls Metric from proto bytes.
func (ms Metric) UnmarshalProto(data []byte) error {
	orig := ms.orig
...
// MarshalJSON marshals Metric into JSON bytes.
func (ms Metric) MarshalJSON() ([]byte, error) {
	orig := ms.orig
...
// UnmarshalJSON unmarshalls Metric from JSON bytes.
func (ms Metric) UnmarshalJSON(data []byte) error {
	orig := ms.orig
