...
// MarshalProto marshals SummaryDataPoint into proto bytes.
func (ms SummaryDataPoint) MarshalProto() ([]byte, error) {
	orig := ms.orig
	size := orig.SizeProto()
	buf := make([]byte, size)
...
// UnmarshalProto unmarshalls SummaryDataPoint from proto bytes.
func (ms SummaryDataPoint) UnmarshalProto(data []byte) error {
	orig := ms.orig
...
// MarshalJSON marshals SummaryDataPoint into JSON bytes.
func (ms SummaryDataPoint) MarshalJSON() ([]byte, error) {
	orig := ms.orig
...
// UnmarshalJSON unmarshalls SummaryDataPoint from JSON bytes.
func (ms SummaryDataPoint) UnmarshalJSON(data []byte) error {
	orig := ms.orig
