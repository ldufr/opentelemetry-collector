...
// MarshalProto marshals ScopeLogs into proto bytes.
func (ms ScopeLogs) MarshalProto() ([]byte, error) {
	orig := ms.orig
	size := orig.SizeProto()
	buf := make([]byte, size)
...
// UnmarshalProto unmarshalls ScopeLogs from proto bytes.
func (ms ScopeLogs) UnmarshalProto(data []byte) error {
	orig := ms.orig
...
// MarshalJSON marshals ScopeLogs into JSON bytes.
func (ms ScopeLogs) MarshalJSON() ([]byte, error) {
	orig := ms.orig
...
// UnmarshalJSON unmarshalls ScopeLogs from JSON bytes.
func (ms ScopeLogs) UnmarshalJSON(data []byte) error {
	orig := ms.orig
