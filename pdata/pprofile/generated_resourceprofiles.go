...
// MarshalProto marshals ResourceProfiles into proto bytes.
func (ms ResourceProfiles) MarshalProto() ([]byte, error) {
	orig := ms.orig
	size := orig.SizeProto()
	buf := make([]byte, size)
...
// UnmarshalProto unmarshalls ResourceProfiles from proto bytes.
func (ms ResourceProfiles) UnmarshalProto(data []byte) error {
	orig := ms.orig
...
// MarshalJSON marshals ResourceProfiles into JSON bytes.
func (ms ResourceProfiles) MarshalJSON() ([]byte, error) {
	orig := ms.orig
...
// UnmarshalJSON unmarshalls ResourceProfiles from JSON bytes.
func (ms ResourceProfiles) UnmarshalJSON(data []byte) error {
	orig := ms.orig
