...
// MarshalProto marshals Link into proto bytes.
func (ms Link) MarshalProto() ([]byte, error) {
	orig := ms.orig
	size := orig.SizeProto()
	buf := make([]byte, size)
...
// UnmarshalProto unmarshalls Link from proto bytes.
func (ms Link) UnmarshalProto(data []byte) error {
	orig := ms.orig
...
// MarshalJSON marshals Link into JSON bytes.
func (ms Link) MarshalJSON() ([]byte, error) {
	orig := ms.orig
...
// UnmarshalJSON unmarshalls Link from JSON bytes.
func (ms Link) UnmarshalJSON(data []byte) error {
	orig := ms.orig
