...
// MarshalProto marshals ScopeSpans into proto bytes.
func (ms ScopeSpans) MarshalProto() ([]byte, error) {
	orig := ms.orig
	size := orig.SizeProto()
	buf := make([]byte, size)
...
// UnmarshalProto unmarshalls ScopeSpans from proto bytes.
func (ms ScopeSpans) UnmarshalProto(data []byte) error {
	orig := ms.orig
...
// MarshalJSON marshals ScopeSpans into JSON bytes.
func (ms ScopeSpans) MarshalJSON() ([]byte, error) {
	orig := ms.orig
...
// UnmarshalJSON unmarshalls ScopeSpans from JSON bytes.
func (ms ScopeSpans) UnmarshalJSON(data []byte) error {
	orig := ms.orig
